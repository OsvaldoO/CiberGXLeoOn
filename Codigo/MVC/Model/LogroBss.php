...
class LogroBss{
	//Atributos
		 ...
		 */
		 ...
		 function otorgar( $detalles, $puntos_otorgados, $cliente_premiado, $nom_juego, $fecha)
		 {
			...
			{
				$conexion->cerrarConexion();
				$logro = new LogroClass( $detalles, $puntos_otorgados, $cliente_premiado, $nom_juego, $fecha);
				return $logro; 
			}
		 }
		...
		function consultar( $clave )
		{
			...
			else
			{
				...
				{
					$logro = new LogroClass( $resultado[0]['detalles'], $resultado[0]['puntos_otorgados'], $resultado[0]['nom_juego'], $resultado[0]['cliente_premiado'], $resultado[0]['fecha']);
					return $logro;
				}
				else 
					return FALSE; 
		...
		function verlogrosCliente( $nick )
		{
			require ('LogroClass.php');
			require ('conexion.php');
			require ('bd_info.inc');
